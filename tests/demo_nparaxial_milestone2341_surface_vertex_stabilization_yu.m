...
function test_event_invalid_normal_local()
    ...
    assert(evt.diagnostic_type(1) == "spherical_true_intersection_local", ...
        'Finite-radius event should use local true-intersection diagnostic.');
...
function test_event_surface_tir_local()
    ...
    assert(evt.diagnostic_type(1) == "spherical_true_intersection_local", ...
        'Finite-radius TIR event should use local true-intersection diagnostic.');
...
function test_worst_surface_vertex_delta_summary_local()
    ...
    evt = validity.event_table;
    surfaceRows = evt(evt.diagnostic_type == ...
