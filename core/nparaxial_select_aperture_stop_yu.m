...
%NPARAXIAL_SELECT_APERTURE_STOP_YU Select the axial aperture stop.
%
% Aperture-stop selection is axial-first-order when y_obj = 0. Off-axis
% lower/upper limiting aperture analysis is handled by
% nparaxial_vignetting_intervals_yu.
    ...
    offAxisWarning = "";
    if abs(y_obj) > tol
        offAxisWarning = ['Aperture-stop selection remains axial-first-order. ', ...
            'This off-axis call reports field-specific launch intervals but ', ...
            'is not full stop re-selection; use ', ...
            'nparaxial_vignetting_intervals_yu for off-axis lower/upper ', ...
            'limiting aperture analysis.'];
    end
