    ...
    methods (Access = private)
        ...
        function lines = equationText(~)
            lines = {
                ...
                '   and vertex-plane spherical-surface scalar diagnostics.'
                '   True ray-sphere intersection validity is deferred to Milestone 2.3.5.'
                ''
                ...
                '   It is not true ray-sphere intersection; that remains deferred to Milestone 2.3.5.'
                ''
